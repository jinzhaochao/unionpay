...
public class LcFeedBackDto implements Serializable{
	...
	public String toString() {
		return "LcFeedBackDto [unid=" + unid + ", sponsorUnid=" + sponsorUnid + ", serviceUnid=" + serviceUnid
				+ ", serviceId=" + serviceId + ", orgId=" + orgId + ", orgName=" + orgName + ", isRead=" + isRead
				+ ", sponsorId=" + sponsorId + ", sponsorName=" + sponsorName + ", feedbackRule=" + feedbackRule
				+ ", feedbackDeadline=" + feedbackDeadline + ", resultForm=" + resultForm + ", workPlan=" + workPlan
				+ ", proposedClosingTime=" + proposedClosingTime + ", feedbackTime=" + feedbackTime + ", progress="
				+ progress + ", workStatus=" + workStatus + ", note=" + note + ", status=" + status + ", changeType="
				+ changeType + ", changeReason=" + changeReason +
				", feedbackUserid=" + feedbackUserid + ", feedbackUsername=" + feedbackUsername+ "]";
	}
