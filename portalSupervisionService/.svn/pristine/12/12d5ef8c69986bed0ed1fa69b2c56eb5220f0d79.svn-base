package com.unionpay.support.business;

import com.alibaba.fastjson.JSONObject;
import com.unionpay.common.util.HttpClientUtils;
import com.unionpay.common.util.ToolUtil;
import com.unionpay.support.model.SendSupportNoticeModel;
 ...
 */
@Component
public class SendSupportNotice {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Value("${http.support.send}")
    private String sendNoticeUrl;

    public boolean sendNotice(SendSupportNoticeModel sendNoticeModelDto){
