		...
		for (SuperServiceOverseeMapping superServiceOverseeMapping : superServiceOverseeMappinglist) {
			...
			if (superServiceOverseeMapping != null) {
				...
				if ("Y".equals(superServiceOverseeMapping.getIsPrimary())) {
				 ...
				 superServiceOverseeMapping.setServiceName(superServiceOverseeMapping.getServiceName());
				 superServiceOverseeMapping.setTaskNote(superServiceOverseeMapping.getTaskNote());
				 ...
				 superServiceOverseeMapping.setOverseeName(superServiceOverseeMapping.getOverseeName());//督办类型
				 superServiceOverseeMapping.setOverseeUnid(superServiceOverseeMapping.getOverseeUnid());//督办类型名称
				 superServiceOverseeMapping.setFileId(superServiceOverseeMapping.getFileId());
