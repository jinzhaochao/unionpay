...
public class SuperSponsorModel {
    ...
    public SuperSponsorModel(String unid, String progress, String sponsorId, String sponsorName, String feedbackUserid, String feedbackUsername, String note, String feedbackDeadline, String feedbackTime, String workStatus, List<SuperTag> tagList, Integer type, String serviceStatus) {
        this.unid = unid;
    ...
    public List<SuperTag> getTagList() {
        return tagList;
    }

    public void setTagList(List<SuperTag> tagList) {
        this.tagList = tagList;
    }
}
