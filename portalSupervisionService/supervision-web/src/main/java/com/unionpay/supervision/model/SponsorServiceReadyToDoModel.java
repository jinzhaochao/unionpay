...
public class SponsorServiceReadyToDoModel extends BaseRowModel {
	...
	private int overseeFrequency;

	//@ExcelProperty(value = { "督办员" }, index = 12)
	private String overseeUsername;

	//@ExcelProperty(value = { "事项状态" }, index = 13)
	private String serviceStatus;
	
	private String jumpUrl;

	private String nextTime;
	//待督办列表，可对每条数据进行反馈要求修改--新需求-0409 lishuang
	private String feedbackRule;
	//事项创建时间--新增-0418 lishuang
	private String createTime;
	//标签
	private String tag;
	//该事项的主办部门中有正在督办的则进行红点提醒  1提醒  0不提醒
	...
	public int getOverseeFrequency() {
		return overseeFrequency;
	}

	public void setOverseeFrequency(int overseeFrequency) {
