...
/**
 * @Author: 翟俊鹏
 * @Date: 2019/4/10/010 9:56
 * @Description:
 */
public class ServerSuggestModel implements Serializable {
    ...
    //转递日志    --jinzhao 2019-12-18
    private List<ServerDeliver> deliverList;

    public ServerSuggestModel() {
    }

    public ServerSuggestModel(int id, Integer serverId, String createtime, String title, String otherDescribe, Integer status, Integer replyId, String replyName, String replyTime, String replyReason, Integer empId, String empName, String empDeptName, Integer empDeptId, Integer empOrgId, Integer type, Integer isDeliver, Integer isAnonymous, Integer complaintDeptId, String complaintDeptName, String timeLength, String replyUserid, List<ServerDeliver> deliverList) {
        this.id = id;
